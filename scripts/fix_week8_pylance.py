#!/usr/bin/env python3
"""Fix week8 notebooks to use subprocess instead of ! shell command."""
...
def fix_notebook(notebook_path):
    """Fix notebook to use subprocess instead of ! command."""
    ...
    for cell in nb['cells']:
        ...
        # Find the setup cell
        if 'SETUP' in code and 'test database' in code:
...
def main():
    ...
    print("=" * 60)
    print("FIXING WEEK 8 NOTEBOOKS FOR PYLANCE COMPATIBILITY")
    print("=" * 60)
